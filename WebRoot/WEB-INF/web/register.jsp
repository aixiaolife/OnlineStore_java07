					...
					<form action="${ ctx }/register.html" method="post" onsubmit="return checkForm();">
						...
						<div class="login">
							...
							<dl>
								<dt>已经拥有账号了？</dt>
								<dd>
									立即登录即可体验在线购物！ <a href="${ctx}/toLogin.html">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
